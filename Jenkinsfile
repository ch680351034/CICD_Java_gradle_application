        ...
        stage("code build and push "){
            ...
            steps{
                script {
                   ...
                   withCredentials([string(credentialsId: 'azure-conreg-password', variable: 'azure-conreg-passwdd')]) {
                       sh '''
                       docker build -t ${REPO_NAME}:${TAG} .
                       docker login -u k8sregistryy -p ${azure-conreg-passwdd} ${REGISTRY_NAME}
